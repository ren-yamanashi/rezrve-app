...
const TeachersRsv = () => {
  ...
  const dateArr = [
    { date: dayArr.today, dateX: dayArr.today, dateY: dayArr.today, number: 0 },
    { date: dayArr.dy, dateX: dayArr.dy, dateY: dayArr.dy, number: 1 },
    { date: dayArr.dy2, dateX: dayArr.dy2, dateY: dayArr.dy2, number: 2 },
    { date: dayArr.dy3, dateX: dayArr.dy3, dateY: dayArr.dy3, number: 3 },
    { date: dayArr.dy4, dateX: dayArr.dy4, dateY: dayArr.dy4, number: 4 },
    { date: dayArr.dy5, dateX: dayArr.dy5, dateY: dayArr.dy5, number: 5 },
    { date: dayArr.dy6, dateX: dayArr.dy6, dateY: dayArr.dy6, number: 6 },
  ];
  const time_arr = [10, 11, 12, 13, 14, 15, 16, 17, 18];
  dateArr.map((item) => {
    item.date.setDate(item.date.getDate() + item.number);
    item.date.setHours(12, 0, 0);
    item.dateX.setDate(item.dateX.getDate() + 7);
    item.dateX.setHours(12, 0, 0);
    console.log(item.dateX);
  });
