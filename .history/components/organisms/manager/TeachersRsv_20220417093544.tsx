...
const TeachersRsv = () => {
  ...
  const [dates, setDates] = useState([
    { id: 1, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 2, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 3, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 4, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 5, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 6, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 7, xxx: initialDate, yyy: initialDate, xx: initialDate },
    { id: 0, xxx: initialDate, yyy: initialDate, xx: initialDate },
  ]);
