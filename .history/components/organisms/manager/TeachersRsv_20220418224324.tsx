...
const TeachersRsv = () => {
  ...
  dateArr.map((item) => {
    ...
    let xx = {
      0: item.number == 0 && new Date(y, m, d, 12, 0, 0),
      1: item.number == 1 && new Date(y, m, d, 12, 0, 0),
      2: item.number == 2 && new Date(y, m, d, 12, 0, 0),
      3: item.number == 3 && new Date(y, m, d, 12, 0, 0),
      4: item.number == 4 && new Date(y, m, d, 12, 0, 0),
      5: item.number == 5 && new Date(y, m, d, 12, 0, 0),
      6: item.number == 6 && new Date(y, m, d, 12, 0, 0),
    };
    let xxx = item.number == 0 && new Date(y, m, d - 7, 12, 0, 0);
    let yyy = item.number == 0 && new Date(y, m, d + 7, 12, 0, 0);
  });
