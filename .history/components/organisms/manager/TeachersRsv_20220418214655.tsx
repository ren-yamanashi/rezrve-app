...
const TeachersRsv = () => {
  ...
  const dateArr = [
    { date: dayArr.today, number: 1 },
    { date: dayArr.dy, number: 2 },
    { date: dayArr.dy2, number: 3 },
    { date: dayArr.dy3, number: 4 },
    { date: dayArr.dy4, number: 5 },
    { date: dayArr.dy5, number: 6 },
    { date: dayArr.dy6, number: 7 },
  ];
