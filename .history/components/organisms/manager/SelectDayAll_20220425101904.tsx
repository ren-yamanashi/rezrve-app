...
const SelectDayAll = () => {
  ...
  useEffect(() => {
    ...
    loadStaffList();
    loadScheduleAll(newDateTime, user_query?.companyId).then(() =>
        ...
        {loading == true ? (
          ...
          <>
            <DateRangePicker
              value={dateValue}
              changeDate={(newValue) => {
                loadScheduleAll(chgDate(newValue), user_query?.companyId);
              }}
            />
            <GetRsv_OK_Cancel />
            <Box overflow="scroll">
        ...
        <CreateShiftModal
          ...
          createShift={(e) =>
            createShift(
              ...
              loadScheduleAll(newDateTime, user_query?.companyId);
            })
          }
        />
        <GetRsvModal
