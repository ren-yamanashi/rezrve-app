...
const TeachersRsv = () => {
  ...
  dayArr.dy.setDate(initialDate.getDate() + 1);
  dayArr.dy2.setDate(initialDate.getDate() + 2);
  dayArr.dy3.setDate(initialDate.getDate() + 3);
  ...
  const dateArr = [today, dayArr.dy, dy2, dy3, dy4, dy5, dy6];
