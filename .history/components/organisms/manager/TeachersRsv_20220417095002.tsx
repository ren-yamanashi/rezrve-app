...
const TeachersRsv = () => {
  ...
  const [dates, setDates] = useState([
    {
      id: 1,
      day: initialDate.setDate(initialDate.getDate() + 1),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 2,
      day: initialDate.setDate(initialDate.getDate() + 2),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 3,
      day: initialDate.setDate(initialDate.getDate() + 3),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 4,
      day: initialDate.setDate(initialDate.getDate() + 4),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 5,
      day: initialDate.setDate(initialDate.getDate() + 5),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 6,
      day: initialDate.setDate(initialDate.getDate() + 6),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 7,
      day: initialDate.setDate(initialDate.getDate() + 7),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
    {
      id: 0,
      day: initialDate.setDate(initialDate.getDate()),
      xxx: initialDate,
      yyy: initialDate,
      xx: initialDate,
    },
  ...
  const dateArr = [today, dy, dy2, dy3, dy4, dy5, dy6];
  dateArr.map((item) => {
    const y = item.getFullYear();
    const m = item.getMonth();
    const d = item.getDate();
    let xxx = new Date(y, m, d - 7, 12, 0, 0);
    item == today && setTest({ ...test, xxx: new Date(y, m, d - 7, 12, 0, 0) });
