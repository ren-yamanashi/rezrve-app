...
const TeachersRsv = () => {
  ...
  dateArr.map((item) => {
    ...
    item.number == 1 &&
      setObject1({ ...object1, 1: new Date(y, m, d, 12, 0, 0) });
    item.number == 2 &&
      setObject1({ ...object1, 2: new Date(y, m, d, 12, 0, 0) });
    item.number == 3 &&
      setObject1({ ...object1, 3: new Date(y, m, d, 12, 0, 0) });
    item.number == 4 &&
      setObject1({ ...object1, 4: new Date(y, m, d, 12, 0, 0) });
    item.number == 5 &&
      setObject1({ ...object1, 5: new Date(y, m, d, 12, 0, 0) });
    item.number == 6 &&
      setObject1({ ...object1, 6: new Date(y, m, d, 12, 0, 0) });
    item.number == 7 &&
      setObject1({ ...object1, 7: new Date(y, m, d, 12, 0, 0) });
  });
