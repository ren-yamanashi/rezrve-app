      ...
      <React.Fragment>
        <>
            ...
            >
              ...
              <Box display="flex" justifyContent="right">
                <IconButton onClick={() => router.back()}>
                  <KeyboardReturnIcon sx={{ color: blue[500], fontSize: 30 }} />
                </IconButton>
                <Button onClick={() => router.back()}>
                  <Typography fontSize={15} component="div" color={blue[600]}>
                    条件を変更する
                  </Typography>
                </Button>
              </Box>
          ...
          >
            ...
            <Box fontSize={25} fontWeight={600} mt={1.5}>
          ...
          <Table size="small" sx={{ borderCollapse: "collapse" }}>
            <TableHead style={{ backgroundColor: "#FFFFDD", border: "3px" }}>
              <TableRow>
                ...
                >
                  ...
                  <Box justifyContent="center" display="flex">
                    {today.getDate() == 1 ? (
                      ...
                      <Box fontSize={25} justifyContent="center" display="flex">
                        {today.getDate()}
                      </Box>
                    )}
                  </Box>
                ...
                {/* value + 1 */}
                <TableCell style={{ fontWeight: 400, width: "13%" }}>
                  <Box fontSize={12} justifyContent="center" display="flex">
                    {day_arr[dy.getDay()]}
                  </Box>
                  {dy.getDate() == 1 ? (
