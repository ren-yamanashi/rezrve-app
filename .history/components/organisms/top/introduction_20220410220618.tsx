    ...
    <>
      <Box
        sx={{
          ...
          flexWrap: "wrap",
          py: 3,
          backgroundImage:{"https://firebasestorage.googleapis.com/v0/b/reserve-app-2c00c.appspot.com/o/images%2Flauren-mancke-aOC7TSLb1o8-unsplash.jpg?alt=media&token=10c46013-9758-4acc-acdb-d3ad92683b6c"}
        }}
      >
        {array.map((index) => (
          <>
