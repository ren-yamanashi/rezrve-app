          ...
          <Media greaterThan="sm">
            <Box sx={{ mt: 1 }} width="30vw" margin="auto">
              <Box
                mb={3}
                sx={{ fontWeight: "bold" }}
              >{`講師名 : ${reserves?.teacher}`}</Box>
              <Box mb={1} sx={{ fontWeight: "bold" }}>{`日時 : ${dayjs(
                reserves?.date.toDate()
              ).format("YYYY/MM/DD ")}${reserves?.time}:00`}</Box>
              <Box display="flex">
                <TextField
                  margin="normal"
                  id="studentName"
          ...
          <Media at="sm">
            <Box sx={{ mt: 1, ml: 5 }} margin="auto">
              ...
              <Box
                mb={1}
                sx={{ fontWeight: "bold", fontSize: 12 }}
              >{`日時 : ${dayjs(reserves?.date.toDate()).format(
                "YYYY/MM/DD "
              )}${reserves?.time}:00`}</Box>
