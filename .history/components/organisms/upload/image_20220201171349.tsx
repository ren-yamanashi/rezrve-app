    ...
    <>
      <React.Fragment>
        ...
        <Box textAlign="center">
          ...
          <Box component="form" noValidate onSubmit={onSubmit2} m="center">
            <Box width="30vw" margin="auto">
              <TextField
                margin="normal"
                required
                id="name"
            ...
            <Button type="submit">名前を更新する</Button>
          </Box>
          <Box textAlign="center">
            <Typography sx={{ fontSize: 20, mt: 5, mx: "auto" }}>
              {`メールアドレス: ${test2}`}
            </Typography>
            <Box width="30vw" mx="auto" mb={3}>
              <TextField
                margin="normal"
                required
                id="email"
