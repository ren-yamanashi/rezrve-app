    ...
    <>
      <React.Fragment>
        ...
        <Box mt={3} display="flex">
          <Box>
            <Button sx={{ bgcolor: teal[400], height: "20px", mr: 1 }} />
            予約済み
          </Box>
          <Box ml={3}>
            <Button sx={{ bgcolor: blue[200], height: "20px", mr: 1 }} />
            予約可能
          </Box>
          <Box ml={3}>
            <Button
