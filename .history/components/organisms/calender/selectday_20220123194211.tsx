          ...
          <Table size="small">
            ...
            <TableBody>
              {freeLists11.map((freeList11) => (
                <TableRow key={freeList11.id}>
                  <TableCell>
                    {`${freeList11.student}  ${freeList11.teacher}  ${freeList11.course}`}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
          ...
          <Table size="small">
            ...
            <TableBody>
              {freeLists10.map((freeList10) => (
                <TableRow key={freeList10.id}>
                  <TableCell>
                    {`${freeList10.student}  ${freeList10.teacher}  ${freeList10.course}`}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
