...
const SelectDayAll = () => {
  ...
  const reserveArr = [
    { rsv: rsv10, error: error10 },
    { rsv: rsv11, error: error11 },
    { rsv: rsv12, error: error12 },
    { rsv: rsv13, error: error13 },
    { rsv: rsv14, error: error14 },
    { rsv: rsv15, error: error15 },
    { rsv: rsv16, error: error16 },
    { rsv: rsv17, error: error17 },
    { rsv: rsv18, error: error18 },
  ];
  const { rsvData } = useSelectReserve();
  ...
  const { changeDateValue, dateValue, newDateTime, chgDate } = useDate();
          ...
          <>
            <DateRangePicker
              ...
              changeDate={async (newValue) =>
                loadScheduleAll(chgDate(newValue))
              }
            />
            <GetRsv_OK_Cancel />
