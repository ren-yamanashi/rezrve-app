...
import { useReserves_Free } from "../../hooks/teacher/reserves/useReserves";
import { useReserves_newValue } from "../../hooks/teacher/reserves/useReserves";
...
export default function FreeSpace() {
  ...
  const { loadRsv, rsv, error } = useReserves_Free();
  const { loadRsvDate, rsv2 } = useReserves_newValue();
        ...
        <MediaContextProvider>
          ...
          <Media greaterThan="sm">
            <Table size="small">
              ...
              {error && error == true && (
                <Alert>予約可能なレッスンが見つかりませんでした</Alert>
              )}
            </Table>
          </Media>
          ...
          >
            <Modals>
              ...
              {err3 == true && <Alert>同時間帯で既に予約済みです</Alert>}
            </Modals>
          </Modal>
          {/* 生徒検索 */}
          <Modal
