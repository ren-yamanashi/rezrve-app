          ...
          <TableBody>
            {freeLists.map((freeList) => (
              <TableRow key={freeList.id}>
                <TableCell>
                  <Box ml={3}>{freeList.time == 10 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 11 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 12 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 13 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 14 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 15 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 16 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 17 && freeList.time}</Box>
                </TableCell>
                <TableCell>
                  <Box ml={3}>{freeList.time == 18 && freeList.time}</Box>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
