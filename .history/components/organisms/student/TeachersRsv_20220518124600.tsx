  ...
  const getReservesX = () => {
    reserves.map((rsv) => {
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[0], "yyyy-MM-dd") && rsv1.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[1], "yyyy-MM-dd") && rsv2.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[2], "yyyy-MM-dd") && rsv3.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[3], "yyyy-MM-dd") && rsv4.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[4], "yyyy-MM-dd") && rsv5.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[5], "yyyy-MM-dd") && rsv6.push(rsv);
      format(new Date(rsv.date), "yyyy-MM-dd") ==
        format(xArr[6], "yyyy-MM-dd") && rsv7.push(rsv);
    });
  };
