...
import { useSelectUser } from "../../../hooks/student/teachersRsv/useSelectUser";
...
export default function TeachersRsv() {
  ...
  const { tch, loadSelectUser } = useSelectUser();
  ...
  useEffect(() => {
    ...
    loadSelectUser(query_.id).then(() => {
      loadRsv_Schedule1_X(tch && tch.userName, xx);
      loadRsv_Schedule2_X(tch && tch.userName, xx2);
      loadRsv_Schedule3_X(tch && tch.userName, xx3);
      loadRsv_Schedule4_X(tch && tch.userName, xx4);
      loadRsv_Schedule5_X(tch && tch.userName, xx5);
      loadRsv_Schedule6_X(tch && tch.userName, xx6);
      loadRsv_Schedule7_X(tch && tch.userName, xx7);
    });
                ...
                >
                  <Box display="flex" justifyContent="center" mx="auto">
                    ...
                    <Title_15
                      ...
                      fontSize={15}
                      color="black"
                      textTitle={tch && tch.userName}
                    />
                    <Box
                      component="img"
                      ml={2}
                      sx={{ height: 50, width: 50, borderRadius: "50%" }}
                      alt={tch && tch.userName}
                      src={tch && tch.url}
                    />
                  </Box>
