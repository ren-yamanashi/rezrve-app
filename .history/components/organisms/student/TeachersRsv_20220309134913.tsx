...
export default function TeachersRsv() {
  ...
  let newX = new Date(yy, mm, dd, 12, 0, 0);
            ...
            <TableBody>
              {time_arr.map((t) => (
                <TableRow key={time_arr.length}>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{`${t}:00`}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>
                        {freeLists.map((i) => i.time == t && new Date(i.date))}
                      </Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists2.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists3.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists4.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists5.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists6.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Box fontSize={10} sx={{ height: 50, width: "10%" }}>
                      <Box>{freeLists7.map((i) => i.time == t && "OK")}</Box>
                    </Box>
                  </TableCell>
                </TableRow>
              ))}
