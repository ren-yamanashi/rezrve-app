...
export default function TeachersRsv() {
  ...
  dy2.setDate(dy.getDate() + 2);
  dy3.setDate(dy.getDate() + 3);
  dy4.setDate(dy.getDate() + 4);
  dy5.setDate(dy.getDate() + 5);
  dy6.setDate(dy.getDate() + 6);
  dy7.setDate(dy.getDate() + 7);
  console.log(dy.getMonth() + 1 + "/" + dy.getDate());
  console.log(dy2.getMonth() + 1 + "/" + dy2.getDate());
  console.log(dy3.getMonth() + 1 + "/" + dy3.getDate());
  console.log(dy4.getMonth() + 1 + "/" + dy4.getDate());
  console.log(dy5.getMonth() + 1 + "/" + dy5.getDate());
  console.log(dy6.getMonth() + 1 + "/" + dy6.getDate());
  console.log(dy7.getMonth() + 1 + "/" + dy7.getDate());
