...
export default function TeachersRsv() {
  ...
  const { loadSelectUser, tch } = useSelectUser();
  ...
  useEffect(() => {
    ...
    loadSelectUser(query_.id).then(() => {
      loadRsv_Schedule1_X(u && u.userName, xx);
      loadRsv_Schedule2_X(u && u.userName, xx2);
      loadRsv_Schedule3_X(u && u.userName, xx3);
      loadRsv_Schedule4_X(u && u.userName, xx4);
      loadRsv_Schedule5_X(u && u.userName, xx5);
      loadRsv_Schedule6_X(u && u.userName, xx6);
      loadRsv_Schedule7_X(u && u.userName, xx7);
    });
