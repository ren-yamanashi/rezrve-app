...
export default function TeachersRsv() {
  ...
  if (v == "成功") {
    ...
    console.log(freeLists2);
    console.log(freeLists3);
    console.log(freeLists4);
    console.log(freeLists5);
    console.log(freeLists6);
    console.log(freeLists7);
  }
  return (
    <>
      <React.Fragment>
