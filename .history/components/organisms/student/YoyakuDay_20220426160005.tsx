...
const RsvDate = () => {
  ...
  const { handleOpen, handleClose2, handleOpen6, handleClose6 } = useHandle();
          ...
          <Media greaterThan="sm">
            <DateRangePicker
              ...
              changeDate={async (newValue) =>
                loadRsv_date(chgDate(newValue), query.id)
              }
            />
            <Table size="small">
                  ...
                  <TableCell style={{ fontWeight: 600, width: "25%" }}>
                    <Box display="flex" ml={1}>
                      ...
                      <Media greaterThan="md">
                        <IconButton
                          onClick={() => loadRsv_date(newDateTime, query.id)}
                        >
                          <RestartAltIcon />
                        </IconButton>
                      </Media>
          ...
          <GetRsvModal
            ...
            clickEv={(e) =>
              loadGetReserves(
                ...
                loadRsv_date(newDateTime, query.id);
