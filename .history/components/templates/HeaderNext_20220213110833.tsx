          ...
          {test2.indexOf("@bee") !== -1 && (
            <Link_mui href={`/user/${user?.uid}`}>
              <ListItem button key="teachers">
                ...
                <ListItemText primary="講師一覧" sx={{ color: "#e3f2fd" }} />
              </ListItem>
            </Link_mui>
          )}
          <Divider />
          {test2.indexOf("@bee") !== -1 && (
            <Link_mui href={`/reserve/${user?.uid}`}>
              <ListItem button key="List">
                <ListItemIcon>
                  <ListIcon sx={{ color: "#e3f2fd" }} />
                </ListItemIcon>
                <ListItemText primary="予約確認" sx={{ color: "#e3f2fd" }} />
              </ListItem>
            </Link_mui>
          )}
          {test2.indexOf("@bee") !== -1 && (
            <Link_mui href={`/shift/${user?.uid}`}>
              <ListItem button key="AddReserve">
                <ListItemIcon>
                  <AddIcon sx={{ color: "#e3f2fd" }} />
                </ListItemIcon>
                <ListItemText primary="予約登録" sx={{ color: "#e3f2fd" }} />
              </ListItem>
            </Link_mui>
          )}
          {test2.indexOf("@bee") !== -1 && (
          ...
          {test2.indexOf("@bee") !== -1 && (
            <Link_mui href={`/calender2/${user?.uid}`}>
              <ListItem button key="Calender">
                <ListItemIcon>
                  <DateRangeIcon sx={{ color: "#e3f2fd" }} />
                </ListItemIcon>
                <ListItemText primary="カレンダー" sx={{ color: "#e3f2fd" }} />
              </ListItem>
            </Link_mui>
          )}
          <Divider />
