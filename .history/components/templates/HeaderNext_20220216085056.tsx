                    ...
                    >
                      ...
                      >
                        <MenuItem>
                          <Button
                            onClick={() =>
                              router.push(`/reserve/all/${user.uid}`)
                            }
                          >
                            予約一覧
                          </Button>
                        ...
                        <MenuItem>
                          <Button
                            onClick={() =>
                              router.push(`/calender2/all/${user?.uid}`)
                            }
                          >
                            予約カレンダー
                          </Button>
                    ...
                    >
                      ...
                      >
                        ...
                        <MenuItem>
                          <Button
                            onClick={() =>
                              router.push(`/calender2/${user?.uid}`)
                            }
                          >
                            予約カレンダー
                          </Button>
                    ...
                    >
                      ...
                      >
                        <MenuItem>
                          <Button
                            onClick={() =>
                              router.push(`/shift/manager/teacher/${user.uid}`)
                            }
                          >
                            講師名で絞り込み
                          </Button>
                        ...
                        <MenuItem>
                          <Button
                            onClick={() =>
                              router.push(`/shift/manager/${user.uid}`)
                            }
                          >
                            日付で絞り込み
                          </Button>
                        ...
                        >
                          <MenuItem>
                            <Button
                              onClick={() =>
                                router.push(
                                  `/shift/students/teacher/${user.uid}`
                                )
                              }
                            >
                              講師名で絞り込み
