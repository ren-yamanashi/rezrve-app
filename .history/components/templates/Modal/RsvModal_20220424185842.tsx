    ...
    <>
      ...
      >
        <Modals>
          ...
          <Item>
            <Box display="flex">
              <TextComponent_17>お客さま電話番号</TextComponent_17>
              <TextComponent>{props.telNumber}</TextComponent>
            </Box>
          </Item>
          <Item2>
            <Box display="flex">
              <TextComponent_17>お客様メールアドレス</TextComponent_17>
              <TextComponent>{props.mailAddress}</TextComponent>
            </Box>
          </Item2>
          <Item>
            <Box display="flex">
