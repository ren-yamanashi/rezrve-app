    ...
    <>
      <Box sx={{ display: "flex" }}>
        ...
        <AppBarComponent>
          <Toolbar>
            <>
              ...
              >
                <InputLabelComponent>{user?.displayName}</InputLabelComponent>
                <SelectComponent>
                  <MenuItemComponent
                    clickEvent={() =>
                      router.push(`/staff/${user?.uid}/profile/`)
                    }
        ...
        <DrawerComponent>
          <Toolbar />
          <List>
            <HomeButton goLink={`/staff/${user?.uid}/home/`} />
            <ShiftButton goLink={`/staff/${user?.uid}/shift/`} />
