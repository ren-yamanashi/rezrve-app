...
export function useReserves() {
	...
	const [loadRsvError,setLoadRsvError] = useRecoilState(loadRsvErrorState);
	function baseQuery() {
		return query (
	...
	return {baseQuery,baseLoading,rsv,rsv_today,rsv_week,loadRsvError,setLoadRsvError}
}
/**=====================================
 * @returns all
 *=====================================*/
export function useReservesAll() {
	const {baseQuery,baseLoading,rsv,loadRsvError,setLoadRsvError} = useReserves()
	const {user} = useAuth();
	async function loadRsvAll() {
		setLoadRsvError(false)
		try {
			const snapshot = await getDocs(query(baseQuery(),orderBy("time","asc")))
			baseLoading(snapshot)
		} catch (error) {
			console.error(error);
			setLoadRsvError(true)
		}
	}
	useEffect(() => {
		if(!process.browser) {
	...
	return {rsv,loadRsvAll,loadRsvError}
}
/**========================================
 * @returns today
 *========================================*/
export function useReserves_Today() {
	const {baseQuery,baseLoading,rsv_today,loadRsvError,setLoadRsvError} = useReserves();
	...
	return {rsv_today,error,loadRsv,loadRsvError}
}
/**=============================
 * @returns onesWeek
 *=============================*/
export function useReserves_Week() {
	const {baseQuery,baseLoading,rsv_week,loadRsvError,setLoadRsvError} = useReserves();
	...
	return {rsv_week,error2,setError2,loadRsv,loadRsvError}
}
/**=============================
 * @returns chancelRsv
 *=============================*/
export function useChancelRsv() {
	const {loadRsvError,setLoadRsvError} = useReserves()
...
return {chancelRsv,loadRsvError}
}
...
export function useReserves_student() {
	...
	return {rsv,error2,setError2,loadRsvStudent,loadRsvError}
}
/**===============================
 ...
 *===============================*/
 export function useReserves_teacher() {
	...
	return {rsv,error2,setError2,loadRsvTeacher,loadRsvError}
}
/**===============================
 * Get Reserves
 *==============================*/
export function useGetReserves() {
	const {baseQuery,loadRsvError,setLoadRsvError} = useReserves();
	...
	return { getReserves,loadRsvError }
}
/**================================
 * @returns Schedule
 *===============================*/
export function useSchedule() {
	...
	return {
		loadSchedule,rsv,
		loadSchedule10,rsv10,
		loadSchedule11,rsv11,
		loadSchedule12,rsv12,
		loadSchedule13,rsv13,
		loadSchedule14,rsv14,
		loadSchedule15,rsv15,
		loadSchedule16,rsv16,
		loadSchedule17,rsv17,
		loadSchedule18,rsv18,
	}
}