...
export const useSchedule = () => {
  ...
  };
  {
    user_query?.times.map((time) => {
      rsvArr.push(
        time == 1 && reserveList.rsv1,
        time == 2 && reserveList.rsv2,
        time == 3 && reserveList.rsv3,
        time == 4 && reserveList.rsv4,
        time == 5 && reserveList.rsv5,
        time == 6 && reserveList.rsv6,
        time == 7 && reserveList.rsv7,
        time == 8 && reserveList.rsv8,
        time == 9 && reserveList.rsv9,
        time == 10 && reserveList.rsv10,
        time == 11 && reserveList.rsv11,
        time == 12 && reserveList.rsv12,
        time == 13 && reserveList.rsv13,
        time == 14 && reserveList.rsv14,
           time == 15
          ? rsv15
          : time == 16
          ? rsv16
