...
export const useSchedules = () => {
	...
	const loadReserve = async(dateTime) => {
		const snapshot = await getDocs(query(baseQuery(dateTime)));
		baseLoading(snapshot)
	}
	return {loadReserve,reserve}
}
/**========= Schedule =========*/
export const useSchedule = () => {
	...
	return {loadScheduleAll,reserveArr,rsv}
}