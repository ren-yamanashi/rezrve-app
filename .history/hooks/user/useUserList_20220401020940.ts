...
/**==============================
 * @returns search studentName next
 *=============================*/
 export function useSearchStudentsList() {
	const {baseLoading_student,baseQuery,studentsList} = useUsers();
	const {user} = useAuth();
	...
	useEffect(() => {
		...
		loadSearchStudentsList(null);
	  }, [process.browser, user]);
	return{loadSearchStudentsList,studentsList}
}
 /**==============================
