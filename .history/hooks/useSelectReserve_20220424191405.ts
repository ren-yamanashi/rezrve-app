...
export const useSelectReserve = () => {
	...
	const setPhoneNumber = (e) => {
		setRsvData({...rsvData,phoneNumber:e.target.value})
	}
	return { selectRsv ,selectTeacher,handleChange,selectStudent,selectReserve,rsvData,setEmail,handleChangeTime,setPhoneNumber};
}
