...
export function useReservesAll() {
	const {baseQuery,baseLoading,rsv,loadError,setLoadError} = useReserves()
	const {user} = useAuth();
	...
	return {rsv,loadRsvAll,loadError}
}
/**========================================
 * @returns today
 *========================================*/
export function useReserves_Today() {
	const {baseQuery,baseLoading,rsv_today,loadError,setLoadError} = useReserves();
	...
	return {rsv_today,error,loadRsv,loadError}
}
/**=============================
 * @returns weekend
 *=============================*/
export function useReserves_Week() {
	...
	return {rsv,error2,loadRsv,loadError}
}
/**===============================
...
export function useReserves_student() {
	...
	return {rsv,error3,setError3,loadRsvStudent,loadError}
}
/**================================
 * @returns Schedule
 *===============================*/
