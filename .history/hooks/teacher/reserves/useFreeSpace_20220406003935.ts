...
export function useFreeSpace_newValue() {
	...
	return {freeSpaces,error,loadFreeSpace_newValue,loadFreeListError}
}
/**================================
...
export function useShiftList_today() {
	...
	return {freeSpaces,error,loadFreeListError}
}
/**================================
...
export function useShiftList_newDate() {
	...
	return {freeSpaces,err,loadFreeSpace_newValue,loadFreeListError}
}