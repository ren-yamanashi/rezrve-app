...
export default function AddFixedReserve() {
  ...
  const dayOfWeekNum = () => {
    if (DayOfWeek == "日曜") {
      setDayOfWeekNumber(0);
    }
    if (DayOfWeek == "月曜") {
      setDayOfWeekNumber(1);
    }
    if (DayOfWeek == "火曜") {
      setDayOfWeekNumber(2);
    }
    if (DayOfWeek == "水曜") {
      setDayOfWeekNumber(3);
    }
    if (DayOfWeek == "木曜") {
      setDayOfWeekNumber(4);
    }
    if (DayOfWeek == "金曜") {
      setDayOfWeekNumber(5);
    }
    if (DayOfWeek == "土曜") {
      setDayOfWeekNumber(6);
    } else {
      console.log("Error");
    }
    return dayOfWeekNum();
