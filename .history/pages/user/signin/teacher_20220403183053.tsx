      ...
      <ThemeProvider theme={theme}>
        <Container component="main" maxWidth="xs">
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={(event) => loadSingUp(event,email,password,router.push("/user/login/teacher");)} sx={{ mt: 1 }}>
              <TextField
                margin="normal"
                required
                fullWidth
              ...
              <Box textAlign="center" mt={1}>
                <Typography>
                  アカウントをお持ちの方は
                  <Button>
                    <Link href="/user/login/teacher">こちら</Link>
                  </Button>
                </Typography>
              </Box>
            </Box>
