            ...
            <Box mt={10}>
              <TabsUnstyled defaultValue={0}>
                <Media greaterThan="lg">
                  <TabsList>
                    <Tab>
                      {`${dayjs(new Date()).format("YYYY/MM/DD ")} の予約`}
                    </Tab>
                    <Tab>1週間の予約</Tab>
                    <Tab>予約カレンダー</Tab>
                    <Tab>予約登録</Tab>
        ...
        <Media at="sm">
          ...
          <Box mt={1}>
            <TabsUnstyled defaultValue={0}>
              <TabsList>
                <Tab>
                  <Box sx={{ fontSize: "5px" }}>1週間の予約</Box>
                </Tab>
                <Tab>
                  <Box sx={{ fontSize: "5px" }}>予約カレンダー </Box>
                </Tab>
                <Tab>
                  <Box sx={{ fontSize: "5px" }}>予約登録 </Box>
                </Tab>
              </TabsList>
              <TabPanel value={0}>
                <Reserve />
